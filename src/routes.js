...
export const ROUTES = {
  ...
  ONCOLOGIA: '/tratamientos/oncologia-integrativa',
  BIENESTAR: '/tratamientos/bienestar-prevencion',
...
export const LEGACY_REDIRECTS = [
  ...
  { from: '/traitements/sueroterapia', to: ROUTES.BIENESTAR },
  { from: ROUTES.SUEROTERAPIA, to: ROUTES.BIENESTAR },
  { from: '/traitements/medecine-regenerative', to: ROUTES.TRAITEMENTS },
  { from: '/traitements/soutien-immunitaire', to: ROUTES.TRAITEMENTS },
  ...
  { from: '/sueroterapia', to: ROUTES.BIENESTAR },
  { from: '/medicina-regenerativa', to: ROUTES.TRAITEMENTS },
  { from: '/soporte-inmunologico', to: ROUTES.TRAITEMENTS },
