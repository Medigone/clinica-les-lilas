...
const WhatsAppButton = ({ floating = false, shortLabel = false, iconOnly = false, className = '' }) => {
  ...
  if (floating) {
    return (
      <a
        ...
        className="fixed bottom-6 right-6 z-50 w-12 h-12 rounded-full bg-[#25D366] hidden md:flex items-center justify-center shadow-lg hover:scale-105 transition-transform duration-200 md:bottom-8 md:right-8"
  ...
  return (
    ...
    >
      ...
      {!iconOnly && t(shortLabel ? 'whatsapp.buttonShort' : 'whatsapp.button')}
    </a>
  );
};
